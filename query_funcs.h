...
/* Added functions */
/*
NOTE: These have been moved to main.cpp after reading assignment description. 
      The assignment description states main.cpp is where code to set up the database
...
void add_player(connection *C, int team_id, int jersey_num, string first_name,
		string last_name, int mpg, int ppg, int rpg, int apg, double spg, double bpg);
